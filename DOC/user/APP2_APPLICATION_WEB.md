...
L'icône KPI apparaît sur votre écran comme une vraie application !
...
2. Chercher par code club (ex: "075" pour Paris)
...
- Imprimer les classements (Ctrl+P)
...
1. Suivre les scores en direct
2. Consulter le classement après chaque journée
3. Analyser les statistiques des adversaires

**Après la compétition** :
1. Voir le classement final
2. Consulter les statistiques complètes
3. Revoir l'historique des matchs
