...
{	
	function Load()
	{
		...
		$sql  = "Select * From gickp_Competitions_Groupes Where id < 5 And id > 0 Order by id";
		...
		$sql  = "Select * From gickp_Competitions_Groupes Where id > 5 And id < 20 Order by id";
		$result = mysql_query($sql, $myBdd->m_link) or die ("Erreur Load 6a");
		$num_results = mysql_num_rows($result);
		...
		$sql  = "Select * From gickp_Competitions_Groupes Where id >= 20 And id < 22 Order by id";
		$result = mysql_query($sql, $myBdd->m_link) or die ("Erreur Load 6a");
		$num_results = mysql_num_rows($result);
