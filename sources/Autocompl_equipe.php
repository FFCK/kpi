...
*/
	...
	while ($row = mysql_fetch_assoc($result)) {
		$code = $row['Numero'];
		//$libelle = __encode($row['Code_club'].' - '.$row['Libelle']);
		//$libelle2 = __encode($row['Libelle']);
		$libelle = $row['Code_club'].' - '.$row['Libelle'];
		$libelle2 = $row['Libelle'];
		echo "$libelle|$code|$libelle2\n";
