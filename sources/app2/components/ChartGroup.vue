        ...
        <table class="w-full text-sm">
          ...
          <tbody>
            <tr v-for="(team, index) in sortedTeams" :key="index" class="border-t">
              ...
              <td class="px-1 py-1 text-center text-xs font-bold">{{ Math.floor((team.t_pts || 0) / 100) }}</td>
              <td class="px-1 py-1 text-center text-xs">{{ team.t_pld || 0 }}</td>
              <td class="px-1 py-1 text-center text-xs">{{ team.t_diff || 0 }}</td>
            </tr>
          </tbody>
        </table>
      </div>
