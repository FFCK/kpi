<template>
  <header class="bg-gray-900 text-white shadow-md">
    ...
    <div v-if="showMenu" class="md:hidden px-4 pb-2">
      <NuxtLink to="/" class="block py-2 hover:text-green-400">Accueil</NuxtLink>
      <NuxtLink to="/games" class="block py-2 hover:text-green-400">Matchs</NuxtLink>
      <NuxtLink to="/charts" class="block py-2 hover:text-green-400">Progression</NuxtLink>
      <NuxtLink to="/login" class="block py-2 hover:text-green-400">Connexion</NuxtLink>
      <NuxtLink to="/about" class="block py-2 hover:text-green-400">A propos</NuxtLink>
    </div>
  </header>
</template>
