      ...
      <div class="row my-3" v-show="faker || startedUrl[20]">
        ...
        <div class="card text-white bg-dark col-md-6">
          ...
          <div class="card-body">
            ...
            <button class="badge bg-secondary m-1" @click="fake(16)">Goal</button>
            <button class="badge bg-secondary m-1" @click="fake(17)">Red</button>
          </div>
          <div class="card-footer">
            <div class="row g-2 align-items-center">
              <div class="col-md-auto">
            ...
            <div class="card-text">
              ...
              <div class="row g-2 align-items-center">
                <div class="col-md-auto">
                  ...
                  <button class="btn btn-sm btn-danger" v-if="validUrl[n] && startedUrl[n]" @click="stopUrl(n)"><i class="bi bi-stop-fill"></i></button>
                </div>
                <div class="col-md">
    ...
    fake (i) {
      ...
      switch (i) {
        ...
        case 6:
          ...
          break
        case 7:
          this.sendMessage(20, '{"currentPeriod": 1, "prolongation": true, "nbPeriodInGame": 4}', '/game/period')
          break
        case 8:
          this.sendMessage(20, '{"currentPeriod": 2, "prolongation": true, "nbPeriodInGame": 4}', '/game/period')
          break
        case 9:
        ...
        case 151:
          ...
          break
        case 16:
          this.sendMessage(20, '{"type": "HOME","idPlayer": 2,"score": "1","fault": 0,"card": "NONE"}', '/game/player-info')
          break
        case 17:
