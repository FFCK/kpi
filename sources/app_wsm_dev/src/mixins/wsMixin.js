...
export default {
  ...
  methods: {
    ...
    async setTeams (id, next = true) {
      const game = await this.fetchGame(null, this.prefs.selectedEvent, id, next)
      if (game) {
        ...
        const players1 = []
        const players2 = []
        const logoTeamA = ''
        const logoTeamB = ''
        for (let i = 1; i <= 10; i++) {
          players1.push({
            id: i,
            name: 'Player ' + i,
