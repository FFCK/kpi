                    ...
                    <table class='tableau table table-striped table-condensed table-responsive table-hover display compact'>
                        <thead>
                            <tr class="text-center">
                                <th colspan="9" class="text-center bg-primary text-white" width="100%">{$arrayDates[i].date} - {#Terrain#} {$terrain}</th>
                            </tr>
                            <tr>
                                ...
                                <tr class='{$Match1.past}'>
                                    {if $Match1.Numero_ordre}
                                        ...
                                        <td class="text-center" data-filter="{$Match1.EquipeA|default:'&nbsp;'}">
                                            <a class="btn btn-xs btn-default"{if $Match1.NumA > 0} href="kpequipes.php?Equipe={$Match1.NumA}&Compet={$Match1.Code_competition}&Css={$Css}" title="{#Palmares#}"{/if}>
                                        ...
                                        <td class="text-center" data-filter="{$Match1.EquipeB|default:'&nbsp;'}">
                                            <a class="btn btn-xs btn-default"{if $Match1.NumB > 0} href="kpequipes.php?Equipe={$Match1.NumB}&Compet={$Match1.Code_competition}&Css={$Css}" title="{#Palmares#}"{/if}>
            ...
            <div class="container-fluid" id="containor">
                <article class="table-responsive col-md-12 padTopBottom">
                    <table class='tableau table table-striped table-condensed table-responsive table-hover display compact'>
                        <thead>
                            <tr class="text-center">
                                <th colspan="6" class="text-center bg-primary text-white" width="48%">{$arrayDates[i].date} - {#Terrain#} {$terrainG}</th>
                                <th rowspan="2" class="text-center" width="4%">{#Heure#}</th>
                                <th colspan="6" class="text-center bg-primary text-white" width="48%">{$arrayDates[i].date} - {#Terrain#} {$terrainD}</th>
                            </tr>
                            <tr>
                                <th>#</th>
                                <th>{#Cat#}</th>
                                ...
                                <tr class='{$Match1.past}'>
                                    ...
                                    {if $Match2.Numero_ordre}
                                        ...
                                        <td class="text-center" data-filter="{$Match2.EquipeA|default:'&nbsp;'}">
                                            <a class="btn btn-xs btn-default"{if $Match2.NumA > 0} href="kpequipes.php?Equipe={$Match2.NumA}&Compet={$Match2.Code_competition}&Css={$Css}" title="{#Palmares#}"{/if}>
                                        ...
                                        <td class="text-center" data-filter="{$Match2.EquipeB|default:'&nbsp;'}">
                                            <a class="btn btn-xs btn-default"{if $Match2.NumB > 0} href="kpequipes.php?Equipe={$Match2.NumB}&Compet={$Match2.Code_competition}&Css={$Css}" title="{#Palmares#}"{/if}>
