  		          ...
  		          {section name=i loop=$arraySchemas}
    		          <tr class='{cycle values="impair,pair"}'>
    		            ...
    		            <td class="cliquableNomEquipe" title="<center>
    		                ...
    		                href='GestionDoc.php?Compet={$arraySchemas[i].Code}&Saison={$arraySchemas[i].Code_saison}'>{if $arraySchemas[i].Titre_actif != 'O' && $arraySchemas[i].Soustitre != ''}{$arraySchemas[i].Soustitre}
    		                {else}{$arraySchemas[i].Libelle}
    		                {/if}
