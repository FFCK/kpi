	...
	<ul id="nav">
		...
		{else}
            ...
            {if $currentmenu == 'Utilisateur'}
				<li class="current"><a href="GestionParamUser.php"><img src="../img/compte.png" height="15" alt="{#Mes_parametres#}" title="{#Mes_parametres#}" > {$userName}</a></li>
            {else}
				<li><a href="GestionParamUser.php"><img src="../img/compte.png" height="15" alt="{#Mes_parametres#}" title="{#Mes_parametres#}" > {$userName}</a></li>
            {/if}
			<li><a href="Logout.php"><img src="../img/logout.png" height="15" alt="{#Deconnexion#}" title="{#Deconnexion#}" ></a></li>
            {if $currentmenu == 'Matchs'}
                <li class="hideall"><a href=""><img src="../img/hideall2.png" height="15" alt="Masquer tout" title="Masquer tout" ></a></li>
            {/if}
		{/if}
	</ul>
