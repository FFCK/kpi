					...
					<div class='blocTop'>
						<table id="formMatch">
							<tr class="hideTr">
								...
								<td>
									Type :
									<img id="typeMatch1" src="../img/type{$Type|default:'C'}.png" {if $Type == "E"} alt="{#Elimination#}"
										title="{#Match_eliminatoire#}" {else} alt="{#Classement#}" title="{#Match_de_classement#}" 
										{/if}
										height="23">
								...
								<td style="text-align: left">
									<table>
										<tr>
											<td>
												<label for="Libelle">{#Intitule_codage#}</label> <img src="../img/information.gif" width="14"
													title="<img src='../img/codage.png' width='250'>">
												<br>
												<input type="text" size="18" name="Libelle" placeholder="{#Code_Exemple#}" value="{$Libelle}"
									...
									<table>
										<tr>
											...
											<td>
												...
												<br>
												<input type="text" size="5" class='champsHeure' name="Heure_match" value="{$Heure_match}"
													tabindex="4" />
											</td>
											<td>
							...
							<tr id='clickdown'>
								<td colspan="6" style="text-align: left; color:#555555"><i><u>{#Afficher_le_formulaire#}</u></i></td>
							</tr>
						</table>
					</div>
				{/if}
						...
						<tr>
							<td width="490">
								<fieldset>
									...
									&nbsp;
									<a href="#" {$TropDeMatchs}
										onclick="setCheckboxes('formJournee', 'checkMatch', true);return false;"><img height="22"
											src="../img/glyphicons-155-more-checked.png" title="{#Tous#}" /></a>
									<a href="#" {$TropDeMatchs}
										onclick="setCheckboxes('formJournee', 'checkMatch', false);return false;"><img height="22"
									...
									{if $profile <= 6 && $AuthModif == 'O'}
										...
										<a href="#" {$TropDeMatchs}
											...
											title="{#Changer_de_poule#} {$TropDeMatchsMsg}"><img height="25" src="../img/Chang.gif"></a>
									{/if}
									<a href="#" {$TropDeMatchs}
							...
							<td width="620">
								<fieldset>
									...
									<a href="FeuilleListeMatchs.php" {$TropDeMatchs} Target="_blank"
										title="Liste des Matchs {$TropDeMatchsMsg}"><img height="25" src="../img/ListeFR.gif" /></a>
									&nbsp;
									<a href="FeuilleListeMatchsEN.php" {$TropDeMatchs} Target="_blank"
										title="Game list (EN) {$TropDeMatchsMsg}"><img height="25" src="../img/ListeEN.gif" /></a>
									&nbsp;
									...
									<tr class='{cycle values="impair,pair"} {$arrayMatchs[i].StdOrSelected}'>
										...
										{if $arrayMatchs[i].MatchAutorisation == 'O' && $profile <= 6 && $AuthModif == 'O'}
											<td class='color{$arrayMatchs[i].Publication}2'>
												<img class="publiMatch" data-valeur="{$arrayMatchs[i].Publication}" data-id="{$arrayMatchs[i].Id}"
													height="25" src="../img/oeil2{$arrayMatchs[i].Publication|default:'N'}.gif"
											...
											{if $arrayMatchs[i].Validation != 'O'}
												...
												{if $PhaseLibelle == 1}
													<td>
														<span class="directInput phase" tabindex='1{$smarty.section.i.iteration|string_format:"%02d"}6'
												...
												{/if}
												<td>
													<img class="typeMatch" data-valeur="{$arrayMatchs[i].Type}" data-id="{$arrayMatchs[i].Id}"
														src="../img/type{$arrayMatchs[i].Type}.png"
														title="{if $arrayMatchs[i].Type == 'C'}{#Match_de_classement#}{else}{#Match_eliminatoire#}{/if}"
														height="23">
												</td>
												<td>
													<span class='directInput terrain' tabindex="1{$smarty.section.i.iteration|string_format:'%02d'}4"
												...
												<td>
													<span class='directInput score' tabindex="2{$smarty.section.i.iteration|string_format:'%02d'}5"
												...
												<td class='color{$arrayMatchs[i].Validation}2'>
													{if $profile <= 6 && $AuthModif == 'O'}
														<img class="verrouMatch" data-valeur="{$arrayMatchs[i].Validation}" data-id="{$arrayMatchs[i].Id}"
															height="25" src="../img/verrou2{$arrayMatchs[i].Validation}.gif"
												...
												<td><span class='directInput score' tabindex="2{$smarty.section.i.iteration|string_format:'%02d'}6"
												...
												<td>
													...
													<a href="GestionMatchEquipeJoueur.php?idMatch={$arrayMatchs[i].Id}&codeEquipe=B"
														title="{#Composition_equipe#} B"><img height="20" src="../img/b_compo_match.png"></a>
												</td>
												<td>
													<span
														class="directInput arbitre{if $arrayMatchs[i].Arbitre_principal != '-1' && $arrayMatchs[i].Matric_arbitre_principal == 0} pbArb{/if}"
														tabindex="2{$smarty.section.i.iteration|string_format:'%02d'}6" data-id="Arbitre_principal"
												...
												<td>
													<span
														...
														tabindex="2{$smarty.section.i.iteration|string_format:'%02d'}6" data-id="Arbitre_secondaire"
														data-match="{$arrayMatchs[i].Id}" data-journee="{$arrayMatchs[i].Id_journee}"
											...
											{else}
												<td><span class='directInputOff numMatch' Id="Numero_ordre-{$arrayMatchs[i].Id}-text"
														tabindex='1{$smarty.section.i.iteration|string_format:"%02d"}0'>{$arrayMatchs[i].Numero_ordre}</span>
												</td>
												<td width=80>
													<a href="#" class="showOff" onclick="ParamMatch({$arrayMatchs[i].Id});"><img height="20"
															src="../img/glyphicons-31-pencil.png" title="{#Editer#}"></a>
													<a href="FeuilleMatchMulti.php?listMatch={$arrayMatchs[i].Id}" Target="_blank"><img height="20"
															src="../img/pdf.png" title="{#Feuille_marque#} (Pdf)"></a>
													<br />
													<a href="#"
														onclick="window.open('FeuilleMarque2.php?idMatch={$arrayMatchs[i].Id}','FeuilleV2'); return false;"><img
															height="20" src="../img/glyphicons-163-ipad.png" title="{#Feuille_marque_en_ligne#}">
													</a>
													{if $profile <= 1}
														<a href="#" onclick="window.open('FeuilleMarque3.php?idMatch={$arrayMatchs[i].Id}','FeuilleV3'); return false;">
															<img height="20" src="../img/ipad-3.png" title="{#Feuille_marque_en_ligne#} (V3)">
												...
												{if $PhaseLibelle == 1}
													<td><span class="directInputOff phase" tabindex='1{$smarty.section.i.iteration|string_format:"%02d"}6'
															data-match="{$arrayMatchs[i].Id}" data-idphase="{$arrayMatchs[i].Id_journee}"
															data-phase="{$arrayMatchs[i].Phase}">{$arrayMatchs[i].Phase|default:'&nbsp;'}</span></td>
													<td><span class='directInputOff text eq' tabindex='1{$smarty.section.i.iteration|string_format:"%02d"}3'
															Id="Libelle-{$arrayMatchs[i].Id}-text">{$arrayMatchs[i].Libelle|default:'&nbsp;'}</span></td>
												{else}
													<td><span class='directInputOff text eq' tabindex='1{$smarty.section.i.iteration|string_format:"%02d"}3'
															Id="Libelle-{$arrayMatchs[i].Id}-text">{$arrayMatchs[i].Libelle|default:'&nbsp;'}</span></td>
												...
												{/if}
												<td>
													<img class="typeMatchOff" data-valeur="{$arrayMatchs[i].Type}" data-id="{$arrayMatchs[i].Id}"
														src="../img/type{$arrayMatchs[i].Type}.png"
														title="{if $arrayMatchs[i].Type == 'C'}{#Match_de_classement#}{else}{#Match_eliminatoire#}{/if}"
														height="23">
												</td>
												<td>
													<span class='directInputOff terrain' tabindex="1{$smarty.section.i.iteration|string_format:'%02d'}4"
												...
												<td>
													...
													<br />
													<a href="GestionMatchEquipeJoueur.php?idMatch={$arrayMatchs[i].Id}&codeEquipe=A"
														title="{#Composition_equipe#} A"><img height="20" src="../img/b_compo_match.png"></a>
												</td>
												<td><span class='directInputOff score' tabindex="2{$smarty.section.i.iteration|string_format:'%02d'}5"
												...
												<td><span class='directInputOff score' tabindex="2{$smarty.section.i.iteration|string_format:'%02d'}6"
														Id="ScoreB-{$arrayMatchs[i].Id}-text">{$arrayMatchs[i].ScoreB}</span></td>
												<td>
										...
										{elseif $arrayMatchs[i].MatchAutorisation == 'O' && $profile == 9 && $AuthModif == 'O'}
											...
											{if $arrayMatchs[i].Validation != 'O'}
												...
												<td class='directInput score' tabindex="2{$smarty.section.i.iteration|string_format:'%02d'}5"><span
														Id="ScoreA-{$arrayMatchs[i].Id}-text">{$arrayMatchs[i].ScoreA}</span></td>
												<td class='color{$arrayMatchs[i].Validation}2'>
													<img height="25" src="../img/verrou2{$arrayMatchs[i].Validation|default:'N'}.gif"
														title="{#Verrouiller#}">
												...
												<td class='directInput score' tabindex="2{$smarty.section.i.iteration|string_format:'%02d'}6"><span
														Id="ScoreB-{$arrayMatchs[i].Id}-text">{$arrayMatchs[i].ScoreB}</span></td>
												<td>
