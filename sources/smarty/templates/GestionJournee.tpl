							...
							<tr class="hideTr">
								...
								<td align="left">
									...
									<td align="left">
										...
										<a href="#" id="InitTitulaireEquipeA" title="{#InitTitulaireEquipe#}"><img height="22"
												src="../img/b_update.png"></a>
										<br>
								...
								<tr class="hideTr">
									<td align="center" colspan="2">
										...
										<a href="#" id="InitTitulaireJournee" title="{#InitTitulaireJournee#}"><img height="22"
												src="../img/b_update.png"></a>
										<br>
									...
									<fieldset>
										...
										<a href="#" {$TropDeMatchs}
											...
											<a href="#" {$TropDeMatchs}
												...
												title="{#Changer_de_poule#} {$TropDeMatchsMsg}"><img height="25" src="../img/Chang.gif"
													border="0"></a>
									...
									<fieldset>
										...
										<a href="../PdfListeMatchsEN.php" {$TropDeMatchs} Target="_blank"
											title="Public Game list (EN) {$TropDeMatchsMsg}"><img height="25" src="../img/ListeEN.gif" /></a>
													...
													{if $profile <= 2}
											&nbsp;
											<a href="../PdfListeMatchs4Terrains.php" {$TropDeMatchs} Target="_blank"
										...
										<tr class='
											...
											<td><input type="checkbox" name="checkMatch" value="{$arrayMatchs[i].Id}"
												...
												<td class='color{$arrayMatchs[i].Publication}2'>
													...
													<td><span class='directInput numMatch' Id="Numero_ordre-{$arrayMatchs[i].Id}-text"
															tabindex='1{$smarty.section.i.iteration|string_format:"%02d"}0'>{$arrayMatchs[i].Numero_ordre}</span>
													</td>
													<td width=80>
														<a href="#" class="showOn" onclick="ParamMatch({$arrayMatchs[i].Id})"><img height="20"
																src="../img/glyphicons-31-pencil.png" title="{#Editer#}" border="0"></a>
														<a href="FeuilleMatchMulti.php?listMatch={$arrayMatchs[i].Id}" Target="_blank"><img height="20"
																src="../img/pdf.png" title="{#Feuille_marque#} (Pdf)" border="0"></a>
														<br />
														<a href="#"
													...
													<td><span class='directInput date
																{if $lang=='en'}EN
																{/if}'
															Id="Date_match-{$arrayMatchs[i].Id}-date
																{if $lang=='en'}EN
																{/if}"
													...
													<td title="{$arrayMatchs[i].Code_competition}"><span
															class="compet">
																...
																{if $PhaseLibelle == 1}
														<td><span class="directInput phase" tabindex='1{$smarty.section.i.iteration|string_format:"%02d"}6'
														...
														<td><span class='directInput text eq' tabindex='1{$smarty.section.i.iteration|string_format:"%02d"}3'
													...
													<td><span class='directInput score' tabindex="2{$smarty.section.i.iteration|string_format:'%02d'}5"
													...
													<td><a href="#" class="showOn"
															onclick="RemoveCheckbox('formJournee', '{$arrayMatchs[i].Id}');return false;"><img height="20"
																src="../img/glyphicons-17-bin.png" title="{#Supprimer#}" border="0"></a></td>
												...
												<td>
													...
													<td title="{$arrayMatchs[i].Code_competition}"><span
														...
														<td colspan=2><span class="lieu">{$arrayMatchs[i].Lieu|default:'&nbsp;'}</span></td>
																...
																{/if}
													<td><img src="../img/type{$arrayMatchs[i].Type}.png"
															title="
																{if $arrayMatchs[i].Type == 'C'}{#Match_de_classement#}
																{else}{#Match_eliminatoire#}
																{/if}" />
													...
													<td>
																...
																{if $arrayMatchs[i].Arbitre_principal != '-1'}{$arrayMatchs[i].Arbitre_principal|replace:'(':'<br>('}
																{else}&nbsp;
																{/if}
													</td>
													<td>

																{if $arrayMatchs[i].Arbitre_secondaire != '-1'}{$arrayMatchs[i].Arbitre_secondaire|replace:'(':'<br>('}
																{else}&nbsp;
																{/if}
													</td>
													<td>
