...
<div class="main">
	...
	<div class="doc-viewer-container">
		...
		<div class="doc-sidebar">
			...
			<!-- Lien vers le README principal -->
			<div class="doc-category">
				<div class="doc-external-links">
					<a href="../README.md" target="_blank" class="doc-external-link" title="README principal du projet">
						🏠 README Principal
					</a>
					<a href="../CLAUDE.md" target="_blank" class="doc-external-link" title="Guide Claude Code">
						🤖 Guide Claude
					</a>
				</div>
			</div>
