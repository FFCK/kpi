  		          ...
  		          <tbody>
  		            {section name=i loop=$arrayCompet}
    		            ...
    		            <tr class='{cycle values="impair,pair"} {$arrayCompet[i].StdOrSelected}'>
    		              ...
    		              <td class="cliquableNomEquipe" title="<center>
    		                  ...
    		                  href='GestionDoc.php?Compet={$arrayCompet[i].Code}'>{if $arrayCompet[i].checktitre != 'O' && $arrayCompet[i].Soustitre != ''}{$arrayCompet[i].Soustitre}{else}{$arrayCompet[i].Libelle}{/if}{if $arrayCompet[i].Soustitre2 != ''}<br />{$arrayCompet[i].Soustitre2}{/if}</a>
    		              </td>
  		    ...
  		    {if $editCompet == ''}
    		    ...
    		    <tr>
    		      <td width=55% colspan=2>
    		        ...
    		        <input type="text" name="codeCompet" maxlength=12 id="codeCompet" {if $profile == 1}class='gris'
    		    ...
    		    <tr>
    		      <td colspan=4>
    		        ...
    		        <input type="text" name="labelCompet" value="{$labelCompet}" maxlength=50 id="labelCompet"
    		          {if $profile == 1}class='gris' {else}readonly{/if} />
    		      </td>
    		    </tr>
    		    <tr>
...
-->
  		  ...
  		  {/if}
  		  {if $user == '42054' or $user == '63155' or $user == '252982'}
    		  <hr>
    		  <div align='center' class='rouge'><i>User Laurent/Eric/Matthieu</i></div>
    		  <table width="100%">
    		    <tr>
    		      <th class='titreForm' colspan=2>
