					...
					<div class='blocTable table2'>
						<table class='tableauJQ tableauClassement tableau'>
							...
							<tbody>
								...
								<tr class='{cycle values="impair,pair"}'>
									<td>{#Equipes#}</td>
									<td>{#Feuilles_de_presence_visa#} FR</td>
									<td><a href="FeuillePresenceVisa.php" Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td>&nbsp;</td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
									<td>{#Equipes#}</td>
								...
								<tr class='{cycle values="impair,pair"}'>
									...
									<td><a href="FeuilleMatchMulti.php?listMatch={$listMatchs}" Target="_blank"><img height="22"
												src="../img/pdf.png" /></a></td>
									<td><a href="../PdfMatchMulti.php?listMatch={$listMatchs}" Target="_blank"><img height="22"
												src="../img/pdf.png" /></a></td>
								</tr>
								{if $detailsCompet.Code_typeclt == 'CHPT'}
									...
									<tr class='{cycle values="impair,pair"}'>
										...
										<td><a href="FeuilleCltNiveauJournee.php" Target="_blank"><img height="22" src="../img/pdf.png" /></a>
										</td>
									...
									{if $profile <= 2}
										...
										<tr class='{cycle values="impair,pair"}'>
											...
											<td><a href="FeuilleCltNiveauPhase.php" Target="_blank"><img height="22" src="../img/pdf.png" /></a>
											</td>
										...
										<tr class='{cycle values="impair,pair"}'>
											<td>{#Classements#}</td>
											<td>{#Detail_par_equipe#}</td>
											<td><a href="FeuilleCltNiveauDetail.php" Target="_blank"><img height="22" src="../img/pdf.png" /></a>
											</td>
								...
								{if $profile <= 2}
										...
										<td>
											<select name="evenement" id="evenement">
												{section name=i loop=$arrayEvenement}
													<Option Value="{$arrayEvenement[i].Id}" {$arrayEvenement[i].Selection}>{$arrayEvenement[i].Libelle}
													</Option>
												{/section}
											</select>
										</td>
									...
									<tr class='{cycle values="impair,pair"}'>
										...
										<td><a id="linkEvt1" href="FeuilleListeMatchs.php?idEvenement=" Target="_blank"><img height="22"
													src="../img/pdf.png" /></a></td>
										<td><a id="linkEvt2" href="../PdfListeMatchs.php?idEvenement=" Target="_blank"><img height="22"
													src="../img/pdf.png" /></a></td>
									</tr>
									<tr class='{cycle values="impair,pair"}'>
										<td>{#Matchs#}</td>
										<td>{#Matchs_de_levenement#} EN</td>
										<td><a id="linkEvt3" href="FeuilleListeMatchsEN.php?idEvenement=" Target="_blank"><img height="22"
													src="../img/pdf.png" /></a></td>
										<td><a id="linkEvt4" href="../PdfListeMatchsEN.php?idEvenement=" Target="_blank"><img height="22"
													src="../img/pdf.png" /></a></td>
									</tr>
									<tr class='{cycle values="impair,pair"}'>
										<td>{#Liens#}</td>
										<td>{#Acces_direct2#}</td>
										<td><a id="linkEvt5" href="../PdfQrCodes.php?" Target="_blank"><img height="22"
													src="../img/pdf.png" /></a></td>
										<td></td>
									</tr>
									<tr class='{cycle values="impair,pair"}'>
										...
										<td><a id="linkEvt6" href="../PdfQrCodeApp.php?" Target="_blank"><img height="22"
													src="../img/pdf.png" /></a></td>
										<td></td>
									</tr>
								{/if}
								...
								<tr class='{cycle values="impair,pair"}'>
									...
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=Buteurs"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td><a href="FeuilleStatsEN.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=Buteurs"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
									<td>Stats</td>
									<td>{#Meilleure_attaque#}</td>
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=Attaque"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td><a href="FeuilleStatsEN.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=Attaque"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
									<td>Stats</td>
									<td>{#Meilleure_defense#}</td>
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=Defense"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td><a href="FeuilleStatsEN.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=Defense"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
									<td>Stats</td>
									<td>{#Cartons#}</td>
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=Cartons"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td><a href="FeuilleStatsEN.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=Cartons"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
									<td>Stats</td>
									<td>{#Cartons_par_equipe#}</td>
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=CartonsEquipe"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td><a href="FeuilleStatsEN.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=CartonsEquipe"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
									<td>Stats</td>
									<td>{#Classement_disciplinaire_individuel#}</td>
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=Fairplay"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td><a href="FeuilleStatsEN.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=Fairplay"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
									<td>Stats</td>
									<td>{#Classement_disciplinaire_par_equipe#}</td>
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=FairplayEquipe"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td><a href="FeuilleStatsEN.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=FairplayEquipe"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
									<td>Stats</td>
									<td>{#Arbitrage#}</td>
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=Arbitrage"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td><a href="FeuilleStatsEN.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=Arbitrage"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
									<td>Stats</td>
									<td>{#Arbitrage_par_equipe#}</td>
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=ArbitrageEquipe"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td><a href="FeuilleStatsEN.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=ArbitrageEquipe"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
								</tr>
								<thead>
									<tr>
								...
								<tr class='{cycle values="impair,pair"}'>
									...
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=CJouees"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td><a href="FeuilleStatsEN.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=CJouees"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
									<td class='rouge'>{#Controle#}</td>
									<td>{#Competitions_jouees_par_equipe#}</td>
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=CJouees2"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td><a href="FeuilleStatsEN.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=CJouees2"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
									<td class='rouge'>{#Controle#}</td>
									<td>{#Irregularites#} ({#Matchs_verrouilles#})</td>
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=CJouees3"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td><a href="FeuilleStatsEN.php?Compets={$detailsCompet.Code}&nbLignes=30&Stat=CJouees3"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
									<td class='rouge'>{#Controle#}</td>
								...
								<tr class='{cycle values="impair,pair"}'>
									...
									<td><a href="FeuilleStats.php?Compets={$detailsCompet.Code}&nbLignes=2000&Stat=CJoueesCF"
											Target="_blank"><img height="22" src="../img/pdf.png" /></a></td>
									<td></td>
								</tr>
								<tr class='{cycle values="impair,pair"}'>
					...
					<table width="100%">
						...
						<tr>
							<td align='center' colspan=4>
								...
								{else}<img height="22" src="../img/oeil2N.gif" />
								{/if}
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td align='center' colspan=3>
								{#Equipes#} <a href='GestionEquipe.php'><img width="10" height="10" src="../img/b_plus.png" alt="Equipes"
										title="{#Equipes#}" /></a>
							</td>
							<td align='center'>
								{$nbEquipes}
						...
						<tr>
							<td align='center' colspan=3>
								<i>{#Feuilles_de_presence#}</i> <a href='GestionCompetition.php'><img width="10" height="10"
										src="../img/b_plus.png" alt="Compétitions" title="{#Competitions#}" /></a>
							</td>
							<td align='center'>
						...
						<tr>
							<td align='center' colspan=3>
								{if $detailsCompet.Code_typeclt == 'CHPT'}
									{#Journees#} <a href='GestionCalendrier.php'><img width="10" height="10" src="../img/b_plus.png"
											alt="Journées" title="Journées" /></a>
								{else}
									{#Phases#} <a href='GestionCalendrier.php'><img width="10" height="10" src="../img/b_plus.png"
											alt="Phases" title="Phases" /></a>
								{/if}
							</td>
							<td align='center'>
								{$nbJournees}
						...
						<tr>
							<td align='center' colspan=3>
								{#Matchs#} <a href='GestionJournee.php'><img width="10" height="10" src="../img/b_plus.png" alt="Matchs"
										title="{#Matchs#}" /></a>
							</td>
							<td align='center'>
								{$nbMatchs}
						...
						<tr>
							<td align='center' colspan=3>
								{#Type_de_classement#} <a href='GestionClassement.php'><img width="10" height="10" src="../img/b_plus.png"
										alt="Classement" title="Classement" /></a>
							</td>
							<td align='center'>
						...
						<tr>
							<td align='center' colspan=3>
								<i>{if $detailsCompet.Date_publication != '00/00/00 à 00h00'}{#Publication#}
										{$detailsCompet.Date_publication}
									{else}{#Prive#}
									{/if}</i>
							</td>
							<td align='center'>{if $detailsCompet.Date_publication != '00/00/00 à 00h00'}<img width="15" height="15"
										src="../img/oeil2O.gif" />
								{else}<img width="15" height="15" src="../img/oeil2N.gif" />
								{/if}
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td align='center' colspan=3>
								{#Statistiques#} <a href='GestionStats.php'><img width="10" height="10" src="../img/b_plus.png"
										alt="Stats" title="Stats" /></a>
							</td>
							<td align='center'>&nbsp;</td>
						</tr>
						<tr>
						...
						<tr>
							<td align='center' colspan=4>{if $detailsCompet.Sponsor_actif == 'O'}<img src='{$detailsCompet.SponsorLink}'
									width=220px><br>{/if}</td>
						</tr>
					</table>
					<table width="100%">
						<tr>
