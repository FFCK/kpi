                ...
                {section name=i loop=$arrayMatchs}
                    ...
                    <tr class='{$arrayMatchs[i].StdOrSelected} {$arrayMatchs[i].past}'>
                            ...
                            <td class="text-center hidden-xs" data-filter="{$arrayMatchs[i].EquipeA|default:'&nbsp;'}">
                                <a class="btn btn-xs btn-default"{if $arrayMatchs[i].NumA > 0} href="frame_equipes.php?Equipe={$arrayMatchs[i].NumA}&Compet={$codeCompet}&Css={$Css}" title="{#Palmares#}"{/if}>
                            ...
                            <td class="text-center hidden-xs" data-filter="{$arrayMatchs[i].EquipeB|default:'&nbsp;'}">
                                <a class="btn btn-xs btn-default"{if $arrayMatchs[i].NumB > 0} href="frame_equipes.php?Equipe={$arrayMatchs[i].NumB}&Compet={$codeCompet}&Css={$Css}" title="{#Palmares#}"{/if}>
                            ...
                            {/if}
                                ...
                                <div class="col-xs-12">
                                    <div class="btn-group btn-block" role="group">
                                        <a class="col-xs-5 text-right"{if $arrayMatchs[i].NumA > 0} href="frame_equipes.php?Equipe={$arrayMatchs[i].NumA}&Compet={$codeCompet}&Css={$Css}" title="{#Palmares#}"{/if}>
                                        ...
                                        <a class="col-xs-5 text-left"{if $arrayMatchs[i].NumB > 0} href="frame_equipes.php?Equipe={$arrayMatchs[i].NumB}&Compet={$codeCompet}&Css={$Css}" title="{#Palmares#}"{/if}>
