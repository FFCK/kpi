                  ...
                  {if $arrayEquipes[$idJournee]}
                    {foreach from=$arrayEquipes[$idJournee] key=myId item=j}
                      <tr>
                        <td></td>
                        <td>
                          <a class="btn btn-xs btn-default equipe" {if $j.Num > 0}
                  ...
                  <div class="col-md-12 text-right chart_match">
                    <table class="pull-right">
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-xs btn-primary equipe" {if $arrayMatchs[$idJournee][j].NumA > 0}
                      ...
                      <tr>
                        <td>
                          <a class="btn btn-xs btn-default equipe" {if $arrayMatchs[$idJournee][j].NumB > 0}
                  ...
                  <div class="col-md-12 text-right chart_match">
                    <table class="pull-right">
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-xs btn-primary equipe" {if $arrayMatchs[$idJournee][j].NumB > 0}
                              href="kpequipes.php?Equipe={$arrayMatchs[$idJournee][j].NumB}&Compet={$codeCompet}&Css={$Css}"
                            title="{#Palmares#}" {/if}>{$arrayMatchs[$idJournee][j].EquipeB}</a>
                      ...
                      <tr>
                        <td>
                          <a class="btn btn-xs btn-default equipe" {if $arrayMatchs[$idJournee][j].NumA > 0}
                              href="kpequipes.php?Equipe={$arrayMatchs[$idJournee][j].NumA}&Compet={$codeCompet}&Css={$Css}"
                            title="{#Palmares#}" {/if}>{$arrayMatchs[$idJournee][j].EquipeA}</a>
