      ...
      {section name=i loop=$arrayListJournees}
        ...
        {if $arrayJournees[$idJournee].Type == 'C'}
          <div class="padBottom table-responsive col-md-12 tablePhase">
            <h4 class="text-center">{$arrayJournees[$idJournee].Phase}</h4>
                ...
                {if $arrayJournees[$idJournee].Actif == 1}
                  {section name=j loop=$arrayEquipe_journee_publi[$idJournee]}
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-sm btn-light border equipe" {if $arrayEquipe_journee_publi[$idJournee][j].Numero > 0}
                  ...
                  {if $arrayEquipes[$idJournee]}
                    {foreach from=$arrayEquipes[$idJournee] key=myId item=j}
                      <tr>
                        <td></td>
                        <td>
                          <a class="btn btn-sm btn-light border equipe" {if $j.Num > 0}
            ...
            {section name=j loop=$arrayMatchs[$idJournee]}
              <div class="row cliquableNomEquipe {if !$smarty.section.j.last}padBottom{/if}">
                {if $arrayMatchs[$idJournee][j].ScoreA > $arrayMatchs[$idJournee][j].ScoreB}
                  <div class="col-md-12 text-end chart_match">
                    <table class="float-end">
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-sm btn-dark border equipe" {if $arrayMatchs[$idJournee][j].NumA > 0}
                          ...
                          <a class="btn btn-sm btn-dark border">{$arrayMatchs[$idJournee][j].ScoreA}</a>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <a class="btn btn-sm btn-light border equipe" {if $arrayMatchs[$idJournee][j].NumB > 0}
                          ...
                          <a class="btn btn-sm btn-light border">{$arrayMatchs[$idJournee][j].ScoreB}</a>
                        </td>
                      </tr>
                    </table>
                  </div>
                  ...
                  <div class="col-md-12 text-right chart_match">
                    <table class="pull-right">
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-sm btn-dark border equipe" {if $arrayMatchs[$idJournee][j].NumB > 0}
                              href="kpequipes.php?Equipe={$arrayMatchs[$idJournee][j].NumB}&Compet={$codeCompet}&Css={$Css}"
                            title="{#Palmares#}" {/if}>{$arrayMatchs[$idJournee][j].EquipeB}</a>
                          <a class="btn btn-sm btn-dark border">{$arrayMatchs[$idJournee][j].ScoreB}</a>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <a class="btn btn-sm btn-light border equipe" {if $arrayMatchs[$idJournee][j].NumA > 0}
                              href="kpequipes.php?Equipe={$arrayMatchs[$idJournee][j].NumA}&Compet={$codeCompet}&Css={$Css}"
                            title="{#Palmares#}" {/if}>{$arrayMatchs[$idJournee][j].EquipeA}</a>
                          <a class="btn btn-sm btn-light border">{$arrayMatchs[$idJournee][j].ScoreA}</a>
                        </td>
                      </tr>
                    </table>
                  </div>
