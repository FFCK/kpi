...
function CreateCache($bCache)
{
	...
	$equipe1 = array(
		'nom' => 'France',
		'competiteurs' => array(
			array('nom' => 'Dupont', 'prenom' => 'Pierre', 'type' => 'Capitaine'),
	...
	$equipe2 = array(
		'nom' => 'Allemagne',
		'competiteurs' => array(
			array('nom' => 'Maier', 'prenom' => 'Hans', 'type' => 'Capitaine'),
	...
	if ($bCache) {
		...
		file_put_contents($_SERVER['DOCUMENT_ROOT'] . "/live/cache/live_score.txt", str_replace($in, $out, ob_get_contents()));
		ob_end_clean();
	}
}
