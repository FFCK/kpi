...
class FeuilleControle extends MyPage
{
    ...
    function __construct()
    {
        ...
        foreach ($resultarray as $key => $row) {
            ...
            $pdf->Cell(25, 10, 'Kayak', 'B', 0, 'C');
            $pdf->Cell(25, 10, 'Gilet', 'B', 0, 'C');
            $pdf->Cell(25, 10, 'Casque', 'B', 0, 'C');
            $pdf->Cell(32, 10, 'Nb pagaies', 'B', 1, 'C');
            ...
            for ($j = 0; $j < $nbJoueurs; $j++) {
                if (isset($arrayJoueur[$idEquipe][$j]['Matric']) && $arrayJoueur[$idEquipe][$j]['Matric'] != '') {
                    ...
                    $pdf->Cell(25, 10, $controlStatus[$arrayJoueur[$idEquipe][$j]['Kayak']], 'B', 0, 'C');
                    $pdf->Cell(25, 10, $controlStatus[$arrayJoueur[$idEquipe][$j]['Gilet']], 'B', 0, 'C');
                    $pdf->Cell(25, 10, $controlStatus[$arrayJoueur[$idEquipe][$j]['Casque']], 'B', 0, 'C');
                    $pdf->Cell(32, 10, $arrayJoueur[$idEquipe][$j]['Pagaies'], 'B', 1, 'C');
                }
            }
        }
