...
-->
      ...
      <script type="text/javascript" src="v2/fm2_ablyA.js?v=<?= NUM_VERSION ?>"></script>
      ...
      <?php if ($readonly != 'O' && $_SESSION['Profile'] > 0 && $_SESSION['Profile'] <= 6) { ?>
        <script type="text/javascript" src="v2/fm2_ablyB.js?v=<?= NUM_VERSION ?>"></script>
      <?php } ?>

      <?php if ($verrou != 'O') { ?>
        <script type="text/javascript" src="v2/fm2_ablyC.js?v=<?= NUM_VERSION ?>"></script>
      <?php }  ?>

      <script type="text/javascript" src="v2/fm2_ablyD.js?v=<?= NUM_VERSION ?>"></script>
      <script>
        $(function() {
      ...
      <script type="text/javascript" src="../commun/ably_api_key.js?<?= NUM_VERSION ?>"></script>
      <script type="text/javascript" src="../js/ably.js?<?= NUM_VERSION ?>"></script>
