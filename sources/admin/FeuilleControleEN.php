...
// Gestion de la Feuille de Contrôle EN - Migration mPDF
...
class FeuilleControle extends MyPage
{
    function __construct()
    {
        ...
        if (strlen($codeCompet) > 0) {
            ...
            if ($num_results == 0) {
                die('No team in this competition');
            }
        ...
        $pdf->Output('Control_Form_' . $arrayCompetition['Soustitre2'] . '.pdf', \Mpdf\Output\Destination::INLINE);
    }
}
