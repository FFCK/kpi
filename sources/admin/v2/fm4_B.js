    ...
    $(function() {
        ...
        $('#controleVerrou').click(function( event ){
            ...
            if($('#scoreA3').text() != $('#scoreA4').text() || $('#scoreB3').text() != $('#scoreB4').text()){
                $('#simple_alert h4.modal-title').text(lang.Attention);
                $('#simple_alert .modal-body').html(lang.score_non_valide);
...
//                });
                ...
                $('#simple_alert h4.modal-title').text(lang.Confirmation + ' ?');
                $('#simple_alert .modal-body').html(lang.controle_feuille);
                $('#simple_alert').modal('show');
