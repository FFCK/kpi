...
<head>
		...
		<link href="v2/bootstrap-theme.min.css" rel="stylesheet">
...
-->		
		...
		<!--<script type="text/javascript" src="v2/bootstrap.min.js"></script>-->
		<script>
			$(function() {
				$('#updateChrono').hide();
									...
									$.post(
										...
										function(data){ // callback
											if(data == 'OK'){
												...
												$('#reset_evt').click();
												window.location = 'mark.php?idMatch=<?php echo $idMatch ?>';
											}
											else{
			...
			<?php if($verrou != 'O') { ?>
				...
				$('.editOfficiel').editable('v2/saveOfficiel.php', {
					...
					indicator : '<img src="v2/images/indicator.gif">',
...
*/					
			...
			<?php	}	?>
				...
				$('#chargeFeuille').click(function(event){
					event.preventDefault();
					window.location = 'mark.php?idMatch=' + $('#idFeuille').val();
				});
				/* ORDRE EVTS */
				var ordre_actuel = 'up';
		...
		<div class="container-fluid">
			...
			<div role="tabpanel">
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#tabParametres" aria-controls="tabParametres" role="tab" data-toggle="tab">Paramètres</a></li>
					<li role="presentation" class="active"><a href="#tabOfficiels" aria-controls="tabOfficiels" role="tab" data-toggle="tab">Officiels</a></li>
					<li role="presentation" class="active"><a href="#tabEquipeA" aria-controls="tabEquipeA" role="tab" data-toggle="tab">
						Equipe A <img src="../img/Pays/<?php echo $paysA; ?>.png" width="25px" height="16" /> <?php echo $row['equipeA']; ?>
						<span class="score" id="scoreA2">0</span></a>
					</li>
					<li role="presentation" class="active"><a href="#tabEquipeB" aria-controls="tabEquipeB" role="tab" data-toggle="tab">
						Equipe B <img src="../img/Pays/<?php echo $paysB; ?>.png" width="25px" height="16" /> <?php echo $row['equipeB']; ?>
						<span class="score" id="scoreB2">0</span></a>
					</li>
					<li role="presentation" class="active"><a href="#tabMatch" aria-controls="tabMatch" role="tab" data-toggle="tab">Déroulement</a></li>
				</ul>
				<div class="tabs_content">
					<div role="tabpanel" class="tab-pane active" id="tabParametres">
						<h3 class="centre"><?php 
					...
					<div role="tabpanel" class="tab-pane" id="tabOfficiels">
						<h3>Officiels</h3>
						<div>
							<div class="moitie">
					...
					<div role="tabpanel" class="tab-pane" id="tabEquipeA">
					...
					<div role="tabpanel" class="tab-pane" id="tabEquipeB">
					...
					<div role="tabpanel" class="tab-pane" id="tabMatch">
							...
							<tr>
								...
								<td id="selectionChrono" class="centre">
									<div id="zoneChrono">
										...
										<span id="chronoText">Chrono : </span><span id="updateChrono"><img src="v2/valider.gif" /></span><input type="text" id="heure" class="fm_input_text" title="Paramètres du chrono" readonly />
