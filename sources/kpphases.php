		...
		if (strlen($codeCompet) > 0) {
            ...
            if ($event > 0) {
                $sql  = "SELECT ce.Id, ce.Numero, ce.Libelle, ce.Code_club, cej.Id_journee, 
                    ...
                    cej.CltNiveau_publi, j.Phase, j.Etape, j.Nbequipes, j.Niveau, j.Type, c.Code_comite_dep, 
            ...
            if ($event > 0) {
                $sql = "SELECT m.Id, m.Id_journee, m.Numero_ordre, m.Date_match, m.Heure_match, m.Libelle, 
                    ...
                    m.ScoreDetailB, m.Id_equipeA, m.Id_equipeB, ce1.Libelle EquipeA, ce2.Libelle EquipeB, 
                    ce1.Numero NumA, ce2.Numero NumB, m.Terrain, m.ScoreA, m.ScoreB, m.CoeffA, m.CoeffB, 
...
//		$this->m_tpl->assign('AlertMessage', $alertMessage);
		$this->DisplayTemplateNew('kpphases');
	}
}		  	
