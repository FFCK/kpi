...
// Gestion de la Feuille de Classement - Type MULTI - Migré vers mPDF via MyPDF

class PdfCltMulti extends MyPage
{
    ...
    function __construct()
    {
        ...
        //données - Classement MULTI publié : seulement Clt, Equipe, Pts, J
        ...
        while ($row = $result->fetch()) {
            ...
            $pdf->Cell(30, 6, $row['Clt_publi'] . '.', 'B', 0, 'C');
            $pdf->Cell(100, 6, $row['Libelle'], 'B', 0, 'L');
            $pdf->Cell(30, 6, $pts, 'B', 0, 'C');
            $pdf->Cell(30, 6, $row['J_publi'], 'B', 1, 'C');
            $i++;
        }
