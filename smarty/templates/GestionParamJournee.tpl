					...
					<table class='tableau2'>
						...
						{if $profile <= 2}
							<tr>
								...
								<td colspan=2><label for="J_competition">Competition</label>
						...
						{else}
							<tr>
								...
								<td colspan=2><label for="J_competition">Competition : </label>{$J_competition}<input type='hidden' name='J_competition' Value='{$J_competition}'/></td>
							</tr>
						{/if}
						<tr>
							<td width="50%">
							...
							<td width="25%">
								...
								{section name=foo start=0 loop=20}
						...
						<tr>
							<td colspan=3 class="vert" align='center'><label><b>Paramètres apparents dans le calendrier public</b></label></td>
						</tr>
						<tr>
							<td class="vert">
							...
							<td colspan=2 class="vert"><label for="Date_fin"><b>Date_fin</b></label><input type="text" class='date' name="Date_fin" value="{$Date_fin}" onfocus="displayCalendar(document.forms[0].Date_fin,'dd/mm/yyyy',this)" ></td>
						</tr>
						<tr>
							...
							<td colspan=2 class="vert"><label for="Departement"><b>Département ou code pays (CIO)</b></label><input type="text" class='dpt' name="Departement" id="Departement" value="{$Departement}" placeholder="N° département ou code pays (CIO)" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan=2><br><label for="Plan_eau">Plan d'eau</label><input type="text" name="Plan_eau" value="{$Plan_eau}"/></td>
						</tr>
						<tr>
							...
							<td colspan=2><label for="Responsable_R1">Responsable local R1</label><input type="text" id="Responsable_R1" name="Responsable_R1" value="{$Responsable_R1}" placeholder="Nom prénom ou numéro de licence" /></td>
						</tr>
						<tr>
							...
							<td colspan=2><label for="ChefArbitre">Chef des arbitres</label><input type="text" id="ChefArbitre" name="ChefArbitre" value="{$ChefArbitre}" placeholder="Nom prénom ou numéro de licence" /></td>
						</tr>
						<tr>
							{if $Num_Journee == 0}
								<td colspan=3><input type="button" onclick="Ok();" name="Sauvegarder" value="Insérer la journée"></td>
							{else}
								<td colspan=3>
						...
						<tr>
							...
							<td colspan=2><label for="CodMatchs">Encoder les matchs de poule *</label><input type="checkbox" name="CodMatchs" value="oui"></td>
						</tr>
						<tr>
							<td colspan=3 align="right"><label>(* Uniquement s'ils ne sont pas déjà encodés)</label></td>
						</tr>
						<tr>
							<td colspan=3>
