    ...
    {else}
        ...
        <div class="flex-footer">
            <div class="btn btn-default text-center">
                ...
                <br>
                {#Notre_partenaire#} <a href="https://www.facebook.com/KIPsport" target="_blank"><img src="../wordpress/wp-content/plugins/social-media-feather/synved-social/image/social/regular/32x32/facebook.png" border="none" width="20"></a> et 
