<html>
	...
	{literal}
		...
		<script language="JavaScript" src="../js/RechercheLicenceIndi.js" type="text/javascript"></script>
	{/literal}
	...
	<body>
		...
		<div class="main">
			...
			<form method="POST" action="RechercheLicenceIndi.php" name="formRerchercheLicenceIndi" id="formRerchercheLicenceIndi" enctype="multipart/form-data">
				<input type='hidden' name='Cmd' Value=''/>

				<div class='blocLeft Left2'>
					<div class='titrePage'>Recherche de licenciés</div>
					<div class='liens'>		
						<a href="#" onclick="CancelRechercheIndi();">Annuler (retour)</a>
					</div>
...
{*									<th>Naissance</th>	*}
							...
							{section name=i loop=$arrayCoureur} 
								<tr>
									<td><input type="checkbox" onclick="OkRechercheIndi({$arrayCoureur[i].Matric},'{$arrayCoureur[i].Nom} {$arrayCoureur[i].Prenom}{if $Arb == '1'} {$arrayCoureur[i].Arbitre}{/if}','{$zoneMatric}', '{$zoneIdentite}');" /></td>
