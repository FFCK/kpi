			<li class='repere'>Compétitions - poules</li>
		</ul>
		<div class="container">
					...
					<div class="col-md-12">
						...
						*}
						<div class="form-inline well">
							...
							<select class="form-control" name="saisonTravail" id="saisonTravail" onChange="sessionSaison()">
							...
							<select class="form-control" name="AfficheNiveau" onChange="changeAffiche()">
							...
							<select class="form-control" name="AfficheCompet" onChange="changeAffiche()">
						...
						<div class='responsive-table-line2' id='blocCompet12'>
										...
										<tr class='{$arrayCompet[i].StdOrSelected}'>
											...
											*}
											...
											<td class='color{$arrayCompet[i].Publication}2 text-center'>
												...
												-->	
													{if $arrayCompet[i].Publication == 'O'}<i class="glyphicon glyphicon-eye-open publiCompet" data-valeur="{$arrayCompet[i].Publication}" data-id="{$arrayCompet[i].Code}" title="Public"></i>
													{else}<i class="glyphicon glyphicon-eye-close publiCompet" data-valeur="{$arrayCompet[i].Publication}" data-id="{$arrayCompet[i].Code}" title="Non public"></i>{/if}
												...
												{elseif $arrayCompet[i].Code_ref != 'M'}
													{if $arrayCompet[i].Publication == 'O'}<i class="glyphicon glyphicon-eye-open"></i>{else}<i class="glyphicon glyphicon-eye-close"></i>{/if}
											...
											{else}<td>&nbsp;</td>{/if}
											<td class="text-center">{$arrayCompet[i].Code_niveau|default:'&nbsp;'}</td>
											...
											<td class="text-center">{if $arrayCompet[i].Code_tour == '10'}F{else}{$arrayCompet[i].Code_tour|default:'&nbsp;'}{/if}</td>
											<td class="text-center">{$arrayCompet[i].codeTypeClt|default:'&nbsp;'}</td>
											...
											<td class="text-center">{$arrayCompet[i].Nb_equipes|default:'&nbsp;'}</td>
											...
											-->
											<td class="text-center">{$arrayCompet[i].nbMatchs|default:'&nbsp;'}</td>
											{if $profile <= 2 && $AuthModif == 'O'}
												<td><a href="#" onclick="RemoveCheckbox('formCompet', '{$arrayCompet[i].Code}');return false;"><i class="glyphicon glyphicon-remove"></i></a></td>
											{else}<td>&nbsp;</td>{/if}
										</tr>
									{/section}
								</tbody>
