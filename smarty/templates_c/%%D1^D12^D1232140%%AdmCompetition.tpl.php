<?php /* Smarty version 2.6.18, created on 2014-11-11 23:50:57
         compiled from AdmCompetition.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'AdmCompetition.tpl', 86, false),)), $this); ?>
		<!--<iframe name="SelectionOuiNon" id="SelectionOuiNon" SRC="SelectionOuiNon.php" width="300" height="120" FRAMEBORDER="yes"></iframe>-->
		<div class="container">
			<form method="POST" action="AdmCompetition.php" name="formCompet" class='form-horizontal' enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class=''>Compétitions / poules</h3>
						<br />
												<div class="form-inline well">
							<label for="saisonTravail" class="">Saison :</label>
							<select class="" name="saisonTravail"  id="saisonTravail" onChange="sessionSaison()">
...
<?php if ($this->_tpl_vars['arraySaison'][$this->_sections['i']['index']]['Code'] == $this->_tpl_vars['sessionSaison']): ?> (Travail)<?php endif; ?></Option>
						...
						<div class='responsive-table-line' id='blocCompet1'>
							<table class='display' id='tableCompet1'>
								<thead class="ui-widget-header"> 
									<tr class="">
										<th><img hspace="2" width="19" height="16" src="/img/oeil2.gif" alt="Publication de la compétition" title="Publication de la compétition" border="0"></th>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?> 
										<tr class='<?php echo $this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['StdOrSelected']; ?>
'>
...
.gif" alt="Publier O/N" title="Publier O/N" border="0">
												...
												-->	
													<?php if ($this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Publication'] == 'O'): ?><i class="glyphicon glyphicon-eye-open publiCompet" data-valeur="<?php echo $this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Publication']; ?>
" data-id="<?php echo $this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Code']; ?>
" title="Public"></i>
													<?php else: ?><i class="glyphicon glyphicon-eye-close publiCompet" data-valeur="<?php echo $this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Publication']; ?>
" data-id="<?php echo $this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Code']; ?>
" title="Non public"></i><?php endif; ?>
...
.gif" alt="Publier O/N" title="<?php if ($this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Publication'] == 'O'): ?>Public<?php else: ?>Non public<?php endif; ?>" />-->
												<?php elseif ($this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Code_ref'] != 'M'): ?>
													<?php if ($this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Publication'] == 'O'): ?><i class="glyphicon glyphicon-eye-open"></i><?php else: ?><i class="glyphicon glyphicon-eye-close"></i><?php endif; ?>
...
')"><img hspace="2" width="18" height="18" src="/img/b_edit.png" alt="Modifier" title="Modifier" border="0"></a></td>
											...
											<td class="text-center"><?php echo ((is_array($_tmp=@$this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Code_niveau'])) ? $this->_run_mod_handler('default', true, $_tmp, '&nbsp;') : smarty_modifier_default($_tmp, '&nbsp;')); ?>
</td>
...
<?php endif; ?></a></td>
											...
											<td class="text-center"><?php if ($this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Code_tour'] == '10'): ?>F<?php else: ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Code_tour'])) ? $this->_run_mod_handler('default', true, $_tmp, '&nbsp;') : smarty_modifier_default($_tmp, '&nbsp;')); ?>
<?php endif; ?></td>
											<td class="text-center"><?php echo ((is_array($_tmp=@$this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['codeTypeClt'])) ? $this->_run_mod_handler('default', true, $_tmp, '&nbsp;') : smarty_modifier_default($_tmp, '&nbsp;')); ?>
</td>
											<td title="Changer le statut" class="text-center">
												<?php if ($this->_tpl_vars['profile'] <= 3 && $this->_tpl_vars['AuthModif'] == 'O'): ?>
...
"><?php echo $this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Statut']; ?>
											...
											<td class="text-center"><?php echo ((is_array($_tmp=@$this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['Nb_equipes'])) ? $this->_run_mod_handler('default', true, $_tmp, '&nbsp;') : smarty_modifier_default($_tmp, '&nbsp;')); ?>
</td>
											<td alt="Verrouiller les feuilles de présence" title="Verrouiller les feuilles de présence" class="text-center">
												<?php if ($this->_tpl_vars['profile'] <= 3 && $this->_tpl_vars['AuthModif'] == 'O'): ?>
												<!--
...
.gif" alt="Verrouillage des Titulaires" title="Verrouillage des Titulaires" />
											...
											-->
											<td class="text-center"><?php echo ((is_array($_tmp=@$this->_tpl_vars['arrayCompet'][$this->_sections['i']['index']]['nbMatchs'])) ? $this->_run_mod_handler('default', true, $_tmp, '&nbsp;') : smarty_modifier_default($_tmp, '&nbsp;')); ?>
</td>
...
');return false;"><i class="glyphicon glyphicon-remove"></i></a></td>
											<?php else: ?><td>&nbsp;</td><?php endif; ?>
										</tr>
									<?php endfor; endif; ?>
								</tbody>
				...
				<div class='row'>
					<div class='blocRight1 col-lg-offset-5 col-lg-2'>
						<?php if ($this->_tpl_vars['profile'] <= 6 || $this->_tpl_vars['profile'] == 9): ?>
							<table width="100%" class='vert'>
								...
								<tr>
									<td>
										<input class='maxWith' type="text" name="accesFeuille" maxlength=15 id="accesFeuille" />
									</td>
									<td>
										<input class='maxWith' type="button" name="accesFeuilleBtn" id="accesFeuilleBtn" value="Accès" />
									</td>
								</tr>
							</table>
						<?php endif; ?>
