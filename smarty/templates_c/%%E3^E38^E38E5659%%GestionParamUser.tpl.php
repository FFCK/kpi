<?php /* Smarty version 2.6.18, created on 2014-11-28 12:15:30
         compiled from GestionParamUser.tpl */ ?>
				...
				<div class='blocRight Right3'>
					<table class='tableau2' width=100%>
						...
						<tr>
							...
							<td width=25%><?php echo $this->_tpl_vars['UNom']; ?>
</td>
							<td width=25%><b>Prénom :</b></td>
							<td width=25%><?php echo $this->_tpl_vars['UPrenom']; ?>
</td>
						</tr>
						<tr>
							<td><b>N° Licence :</b></td>
							<td><?php echo $this->_tpl_vars['UCode']; ?>
</td>
							<td><b>Saison :</b></td>
							<td><?php echo $this->_tpl_vars['USaison']; ?>
</td>
						</tr>
						<tr>
							<td><b>Club :</b></td>
							<td colspan=3><?php echo $this->_tpl_vars['UClub']; ?>
</td>
						</tr>
						<tr>
							<td width=25%><b>Pagaie EV :</b></td>
							<td width=25%><?php echo $this->_tpl_vars['UPagaie_EVI']; ?>
</td>
							<td width=25%><b>Pagaie Mer :</b></td>
							<td width=25%><?php echo $this->_tpl_vars['UPagaie_MER']; ?>
</td>
						</tr>
						<tr>
							<td width=25%><b>Pagaie EC :</b></td>
							<td width=25%><?php echo $this->_tpl_vars['UPagaie_ECA']; ?>
</td>
						</tr>
						<tr>
							<th class='titreForm' colspan=4 width='100%'>
						...
						<tr>
							<td colspan=4><b>Fonctions :</b><input type="text" name="Fonction" value="<?php echo $this->_tpl_vars['UFonction']; ?>
" maxlength=40 /></td>
						</tr>
						<tr>
							<td colspan=2><b>Email :</b><input type="text" name="Mail1" value="<?php echo $this->_tpl_vars['UMail']; ?>
" onChange="detectChangeMail()" maxlength=40 /></td>
							<td colspan=2><b>Confirmez email :</b><input type="text" name="Mail2" value="" maxlength=40 /></td>
						</tr>
						<tr>
							<td colspan=2><b>Téléphone :</b><input type="text" name="Tel" value="<?php echo $this->_tpl_vars['UTel']; ?>
" maxlength=15 /></td>
							<td colspan=2></td>
						</tr>
						<tr>
