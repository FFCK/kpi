...
dbhost = "cl1-sql1"				; Name or IP of your database server
dbname = "poloweb4"					; The name of the database
dbuser = "poloweb4"				; The user to access the database
dbpass = "***"				; The password to go with that username above
dbprefix = "flyspray_"				; The prefix to the Flyspray tables


[general]
cookiesalt = "c1bb9271cff7d098415b1031eac35c23"			; Randomisation value for cookie encoding
